...
export class MyApp {
  ...
  constructor(public platform: Platform,
    ...
    this.pages = [
      ...
      { title: 'Syllabus', component: ExamPage, active: false, icon: 'book', showcount: false },
      { title: 'Student Info Report', component: StureptPage, active: false, icon: 'document', showcount: false },
      { title: 'Student Attendence Report', component: HomePage, active: false, icon: 'document', showcount: false },
      { title: 'Student Fee Report', component: HomePage, active: false, icon: 'document', showcount: false },
      { title: 'Exam Schedule', component: HomePage, active: false, icon: 'document', showcount: false },
